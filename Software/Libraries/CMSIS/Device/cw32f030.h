...
typedef struct                                  /*!< (@ 0x40002800) RTC Structure                                              */
{
    ...
    union
    {
        ...
        {
            __IOM uint32_t SECOND     : 7;            /*!< [6..0] desc SECOND                                                        */
            __IOM uint32_t SECONDMASK : 1;            /*!< [7..7] desc SECONDMASK                                                    */
            __IOM uint32_t MINUTE     : 7;            /*!< [14..8] desc MINUTE                                                       */
            __IOM uint32_t MINUTEMASK : 1;            /*!< [15..15] desc MINUTEMASK                                                  */
            __IOM uint32_t HOUR       : 6;            /*!< [21..16] desc HOUR                                                        */
            __IM  uint32_t            : 1;
            __IOM uint32_t HOURMASK   : 1;            /*!< [23..23] desc HOURMASK                                                    */
            __IOM uint32_t WEEK       : 7;            /*!< [30..24] desc WEEK                                                        */
        } ALARMA_f;
    } ;
...
typedef struct                                  /*!< (@ 0x40010000) SYSCTRL Structure                                          */
{
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t FREQ       : 2;            /*!< [3..2] desc FREQ                                                          */
    ...
    union
    {
        ...
        struct
        {
            ...
            __IM  uint32_t STABLE     : 1;            /*!< [15..15] desc STABLE                                                      */
            __IOM uint32_t RFU        : 4;            /*!< [19..16] desc RFU                                                         */
        } PLL_f;
    } ;
...
#define M0P_ADC                         ((ADC_TypeDef*)               ADC_BASE)
#define M0P_ATIM                        ((ATIM_TypeDef*)              ATIM_BASE)
#define M0P_AWT                         ((AWT_TypeDef*)               AWT_BASE)
#define M0P_BTIM1                       ((BTIM_TypeDef*)              BTIM1_BASE)
#define M0P_BTIM2                       ((BTIM_TypeDef*)              BTIM2_BASE)
#define M0P_BTIM3                       ((BTIM_TypeDef*)              BTIM3_BASE)
#define M0P_CRC                         ((CRC_TypeDef*)               CRC_BASE)
#define M0P_DMA                         ((DMA_TypeDef*)               DMA_BASE)
#define M0P_DMACHANNEL1                 ((DMACHANNEL_TypeDef*)        DMACHANNEL1_BASE)
#define M0P_DMACHANNEL2                 ((DMACHANNEL_TypeDef*)        DMACHANNEL2_BASE)
#define M0P_DMACHANNEL3                 ((DMACHANNEL_TypeDef*)        DMACHANNEL3_BASE)
#define M0P_DMACHANNEL4                 ((DMACHANNEL_TypeDef*)        DMACHANNEL4_BASE)
#define M0P_DMACHANNEL5                 ((DMACHANNEL_TypeDef*)        DMACHANNEL5_BASE)
#define M0P_FLASH                       ((FLASH_TypeDef*)             FLASH_BASE)
#define M0P_GPIOA                       ((GPIO_TypeDef*)              GPIOA_BASE)
#define M0P_GPIOB                       ((GPIO_TypeDef*)              GPIOB_BASE)
#define M0P_GPIOC                       ((GPIO_TypeDef*)             GPIOC_BASE)
#define M0P_GPIOF                       ((GPIO_TypeDef*)             GPIOF_BASE)
#define M0P_GTIM1                       ((GTIM_TypeDef*)              GTIM1_BASE)
#define M0P_GTIM2                       ((GTIM_TypeDef*)              GTIM2_BASE)
#define M0P_GTIM3                       ((GTIM_TypeDef*)              GTIM3_BASE)
#define M0P_GTIM4                       ((GTIM_TypeDef*)              GTIM4_BASE)
#define M0P_I2C1                        ((I2C_TypeDef*)               I2C1_BASE)
#define M0P_I2C2                        ((I2C_TypeDef*)               I2C2_BASE)
#define M0P_IWDT                        ((IWDT_TypeDef*)              IWDT_BASE)
#define M0P_LVD                         ((LVD_TypeDef*)               LVD_BASE)
#define M0P_RAM                         ((RAM_TypeDef*)               RAM_BASE)
#define M0P_RTC                         ((RTC_TypeDef*)               RTC_BASE)
#define M0P_SPI1                        ((SPI_TypeDef*)               SPI1_BASE)
#define M0P_SPI2                        ((SPI_TypeDef*)               SPI2_BASE)
#define M0P_SYSCTRL                     ((SYSCTRL_TypeDef*)           SYSCTRL_BASE)
#define M0P_UART1                       ((UART_TypeDef*)              UART1_BASE)
#define M0P_UART2                       ((UART_TypeDef*)              UART2_BASE)
#define M0P_UART3                       ((UART_TypeDef*)              UART3_BASE)
#define M0P_VC1                         ((VC_TypeDef*)                VC1_BASE)
#define M0P_VC2                         ((VC_TypeDef*)                VC2_BASE)
#define M0P_WWDT                        ((WWDT_TypeDef*)              WWDT_BASE)

#define CW_ADC                          M0P_ADC
#define CW_ATIM                         M0P_ATIM
#define CW_AWT                          M0P_AWT
#define CW_BTIM1                        M0P_BTIM1
#define CW_BTIM2                        M0P_BTIM2
#define CW_BTIM3                        M0P_BTIM3
#define CW_CRC                          M0P_CRC
#define CW_DMA                          M0P_DMA
#define CW_DMACHANNEL1                  M0P_DMACHANNEL1
#define CW_DMACHANNEL2                  M0P_DMACHANNEL2
#define CW_DMACHANNEL3                  M0P_DMACHANNEL3
#define CW_DMACHANNEL4                  M0P_DMACHANNEL4
#define CW_DMACHANNEL5                  M0P_DMACHANNEL5
#define CW_FLASH                        M0P_FLASH
#define CW_GPIOA                        M0P_GPIOA
#define CW_GPIOB                        M0P_GPIOB
#define CW_GPIOC                        M0P_GPIOC
#define CW_GPIOF                        M0P_GPIOF
#define CW_GTIM1                        M0P_GTIM1
#define CW_GTIM2                        M0P_GTIM2
#define CW_GTIM3                        M0P_GTIM3
#define CW_GTIM4                        M0P_GTIM4
#define CW_I2C1                         M0P_I2C1
#define CW_I2C2                         M0P_I2C2
#define CW_IWDT                         M0P_IWDT
#define CW_LVD                          M0P_LVD
#define CW_RAM                          M0P_RAM
#define CW_RTC                          M0P_RTC
#define CW_SPI1                         M0P_SPI1
#define CW_SPI2                         M0P_SPI2
#define CW_SYSCTRL                      M0P_SYSCTRL
#define CW_UART1                        M0P_UART1
#define CW_UART2                        M0P_UART2
#define CW_UART3                        M0P_UART3
#define CW_VC1                          M0P_VC1
#define CW_VC2                          M0P_VC2
#define CW_WWDT                         M0P_WWDT
...
#define RTC_ALARMB_HOURMASK_Pos           (23UL)                    /*!< HOURMASK (Bit 23)                                     */
#define RTC_ALARMB_HOURMASK_Msk           (0x800000UL)              /*!< HOURMASK (Bitfield-Mask: 0x01)                        */
#define RTC_ALARMB_HOUR_Pos               (16UL)                    /*!< HOUR (Bit 16)                                         */
#define RTC_ALARMB_HOUR_Msk               (0x3f0000UL)              /*!< HOUR (Bitfield-Mask: 0x3f)                            */
#define RTC_ALARMB_MINUTEMASK_Pos         (15UL)                    /*!< MINUTEMASK (Bit 15)                                   */
#define RTC_ALARMB_MINUTEMASK_Msk         (0x8000UL)                /*!< MINUTEMASK (Bitfield-Mask: 0x01)                      */
#define RTC_ALARMB_MINUTE_Pos             (8UL)                     /*!< MINUTE (Bit 8)                                        */
#define RTC_ALARMB_MINUTE_Msk             (0x7f00UL)                /*!< MINUTE (Bitfield-Mask: 0x7f)                          */
#define RTC_ALARMB_SECONDMASK_Pos         (7UL)                     /*!< SECONDMASK (Bit 7)                                    */
#define RTC_ALARMB_SECONDMASK_Msk         (0x80UL)                  /*!< SECONDMASK (Bitfield-Mask: 0x01)                      */
...
#define SYSCTRL_HSE_FREQ_Pos              (2UL)                     /*!< FREQ (Bit 2)                                          */
#define SYSCTRL_HSE_FREQ_Msk              (0xcUL)                   /*!< FREQ (Bitfield-Mask: 0x03)                            */
...
/* ==========================================================  PLL  ========================================================== */
#define SYSCTRL_PLL_RFU_Pos               (16UL)                    /*!< RFU (Bit 16)                                          */
#define SYSCTRL_PLL_RFU_Msk               (0xf0000UL)               /*!< RFU (Bitfield-Mask: 0x0f)                             */
